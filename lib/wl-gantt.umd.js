...
// CONCATENATED MODULE: ./src/pages/wl-gantt/index.vue?vue&type=template&id=4adc50dd&
...
/* harmony default export */ var wl_ganttvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    ganttTitleDate: function ganttTitleDate() {
      ...
      var start_mouth = Number(start_date_spilt[1]); // let start_day = Number(start_date_spilt[2])

      var end_year = Number(end_date_spilt[0]);
      var end_mouth = Number(end_date_spilt[1]); // let end_day = Number(end_date_spilt[2])
      // 自动更新日期类型以适应任务时间范围跨度
