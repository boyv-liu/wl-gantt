...
// CONCATENATED MODULE: ./src/pages/wl-gantt/index.vue?vue&type=template&id=76916138&
  ...
  computed: {
    ...
    ganttTitleDate: function ganttTitleDate() {
      ...
      if (this.self_date_type === 'yearAndWeek') {
        ...
        // start_year,
        start_mouth, // end_year,
        end_mouth, start_day, end_day);
      } else {
